    ...
    <main class="routes-container">
        ...
        <section class="routes-grid-section">
            <div class="routes-grid">
                <!-- Route Card 1 -->
                <?php
                include_once("php/listar_itinerario.php");
                    ...
                    <div class="route-card-content">
                        <div class="route-header">
                            <div class="route-icon-wrapper">
                               <md-icon class="route-icon">map</md-icon>
                            </div>
                            <div class="route-info">
                                <h3 class="route-name">Itinerário '.$itinerario['id_itinerario'].'</h3>
                            </div>
                        </div>

                        <div class="route-details">
                            <div class="route-path">
                                <span class="station">'.$itinerario['nome_origem'].'</span>
                                <md-icon class="path-arrow">arrow_forward</md-icon>
                                <span class="station">'.$itinerario['nome_destino'].'</span>
                            </div>
                        </div>
